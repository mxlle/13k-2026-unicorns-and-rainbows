 ...
 * (a payout being counted in, a present's loot arriving — one and the same sound today), and
 * UNICORN is ChestLoot.UNICORN — so a currency or a loot value *is* the sound it makes, and no
 * lookup sits between them.
 *
