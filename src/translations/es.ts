...
export function getEsTranslationMap(): Record<TranslationKey, string> {
  return {
    ...
    [TranslationKey.INFO_UNICORN_SHINE]:
      "Alinea 🦄⛲🌈 o 🦄🍭🌈 para que brille. Brillar sube su rango. Cada rango hace que su 🌈 valga más.",
    [TranslationKey.INFO_RAINBOW]: "Arcoíris|Suma puntos mientras brilla.",
    [TranslationKey.INFO_FOUNTAIN]: "Fuente|Alinea 🦄⛲🌈. Sus 🌈 hacen 💧.",
    ...
    // "Caramelo" rather than a regional word for the lollipop itself: chupetín, paleta and
    // piruleta each pick one country, and the glyph is in the line anyway.
    ...
    [TranslationKey.INFO_TREE_SITE]: "Brote|Un unicornio al lado puede convertirlo en un 🍭.",
