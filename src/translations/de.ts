...
export function getDeTranslationMap(): Record<TranslationKey, string> {
  return {
    ...
    [TranslationKey.INFO_TREE]: "Lollibaum|Er macht aus dem 💧 jedes 🌈 daneben 🍬.",
    ...
    [TranslationKey.INFO_CHEST]: "Geschenk|Betritt es zum Öffnen.",
    ...
    [TranslationKey.INFO_DARK_RAINBOW]: "Dunkler Regenbogen|Er zählt für deinen Rivalen.",
