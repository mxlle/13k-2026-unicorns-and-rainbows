...
export function getDeTranslationMap(): Record<TranslationKey, string> {
  return {
    ...
    [TranslationKey.INFO_UNICORN_SHINE]:
      "Stell es so auf, damit es leuchtet: 🦄⛲🌈 oder 🦄🍭🌈. Leuchten erhöht seinen Rang. Mit jedem Rang wird sein 🌈 wertvoller.",
    [TranslationKey.INFO_RAINBOW]: "Regenbogen|Punktet, solange er leuchtet.",
    [TranslationKey.INFO_FOUNTAIN]: "Brunnen|Reihe 🦄⛲🌈 auf. Seine 🌈 machen 💧.",
    ...
    [TranslationKey.INFO_TREE_SITE]: "Setzling|Ein Einhorn daneben kann daraus einen 🍭 ziehen.",
